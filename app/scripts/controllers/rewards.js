(function() {
  ...
  app.config(['$routeProvider', function($routeProvider) {
    $routeProvider.when('/rewards/:locale/:year/:category/:node/:call', {
      ...
      resolve: {
        ...
        rewardsData: [
          ...
          'GoteoApi', function($route, GoteoApi) {
            ...
            return GoteoApi.getData('rewards', locale, year, category, node, call);
          }
        ],
        licensesData: [
          '$route',
          'GoteoApi', function($route, GoteoApi) {
            var year = parseInt($route.current.params.year),
              ...
              call = $route.current.params.call,
              locale = $route.current.params.locale;
            return GoteoApi.getData('licenses', locale, year, category, node, call);
          }
        ]
      }
    });
  ...
  app.controller('RewardsCtrl', [
    ...
    'rewardsData',
    'licensesData',
    function ($timeout, $translate, $scope, $rootScope, $routeParams, categories, nodes, calls, rewardsData, licensesData) {
